...
pub struct AnswerRequestInitStage {
    ...
    /// unauthenticated.
    #[prost(string, tag="4")]
    pub caller_auth_entity: ::prost::alloc::string::String,
    ...
    pub caller_auth_metadata: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
...
pub struct ReportConnectionMetadataRequest {
    ...
    #[prost(enumeration="DialStage", tag="3")]
    ...
    #[prost(enumeration="ConnectionSignalingPath", tag="5")]
